// Operator-provided Data Protection Statement (English, as supplied).
// NOTE: this is legal text — for a German business the German version is the
// authoritative one; have any translation reviewed by a lawyer, and make sure
// the trackers described here (Adobe/Google Analytics, Facebook Pixel) match
...
export const privacyDocument: PrivacyDocument = {
  updated: "As of: May 2018 / AG",
  sections: [
    {
      id: "general",
      ...
      blocks: [
        {
          type: "p",
          text: "This website is operated by GbR, Elfbuchenstraße 18, 34119 Kassel, Germany, info@schnucken.com (hereinafter “we” or “us”). If you have any questions regarding data protection, please contact us at the contact details above.",
        },
      ],
    },
    {
      id: "processing",
      heading: "2. Processing of personal data and transfer to third parties",
      blocks: [
        {
          type: "p",
          text: "2.1 Upon use of our website, some personal data are automatically collected about your device (computer, mobile phone, tablet etc.). The IP address currently being used by your device, date, time, browser, operating system of your device, and the pages retrieved are collected. This happens for the purpose of data security, to optimize our range and to improve our website. The personal data is processed on the basis of art. 6, para. 1, sentence 1, letter f) GDPR (General Data Protection Regulation). The protection of our website and the optimization of our services represent a legitimate interest on our part.",
        },
        {
          type: "p",
          text: "2.2 If you contact us (e.g., via a request to the contact details provided by us), we will process only such personal data that you have communicated to us and that is necessary to process and answer your request.",
        },
        {
          type: "p",
          text: "2.3 In order to enable the data processing operations stated in this Data Protection Statement, e.g., for hosting and maintaining our website, we deploy service providers.",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        { type: "p", text: "To exercise your rights as per the GDPR to" },
        {
          type: "list",
          items: [
        ...
        {
          type: "p",
          text: "you can contact us at any time at the contact details stated in no. 1. In addition, you have the right to raise a complaint at the competent supervisory authority, if you regard the data processing to be incompatible with the GDPR (art. 77 GDPR).",
        },
      ],
    },
  ],
